...
export const serviceAccountsApi = {
  ...
  create: (data: { name: string; json_content: any; client_email?: string; domain?: string; project_id?: string; admin_email?: string }) => api.post('/accounts/', data),
...
export const dataListsApi = {
  list: () => api.get('/data-lists/'),
  get: (id: number) => api.get(`/data-lists/${id}`),
  create: (data: any) => api.post('/data-lists/', data),
  update: (id: number, data: any) => api.put(`/data-lists/${id}`, data),
  delete: (id: number) => api.delete(`/data-lists/${id}`),
  search: (query: string) => api.get(`/data-lists/search/${query}`),
};
