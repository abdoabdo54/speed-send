...
echo "🎯 Features:"
echo "   - Backend API filters admin users from /api/v1/users/"
echo "   - Frontend double-filters admin users in UI"
echo "   - Sending logic excludes admin users from sender pool"
echo "   - Comprehensive admin pattern detection"
